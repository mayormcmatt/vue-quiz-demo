<template>
	<div id="app">
		...
		<div class="main-content">
			...
			<quizComponent v-for="question in questions" :question="question.question" :id="question.id" :options="question.options"
			    :hintText="question.hintText" :qNum="qNum" @nextQuestionPlease="qNum++">
			</quizComponent>
		</div>
	</div>
</template>
